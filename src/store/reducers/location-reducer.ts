...
const initialState: LocationState = { isLoading: false, isError: false, locations: [] };
...
const reducer = (state: LocationState = initialState, action: LocationAction): LocationState => {
    switch (action.type) {
        case LocationActionTypes.GET_ALL_LOCATIONS:
            return { isLoading: true, isError: false, locations: action.payload };
        case LocationActionTypes.GET_SELECTED_LOCATION:
            return { isLoading: true, isError: false, location: action.payload };
        ...
        case LocationActionTypes.LOCATION_SUCCESS:
            return { isLoading: false, isError: false, locationResponse: action.payload };
        case LocationActionTypes.UPDATE_LOCATION:
            return { isLoading: true, isError: false, updateLocation: action.payload };
